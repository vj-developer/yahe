...
public class SliderItemFragment extends Fragment {
    ...
    @StringRes
    private static final int[] PAGE_TITLES = new int[]{R.string.discover, R.string.orderfavourite, R.string.fastdeliver};

    // prepare all subtitle ids arrays
    @StringRes
    private static final int[] PAGE_TEXT = new int[]{R.string.discover_text, R.string.orderfavouritetext, R.string.fastdelivertext};
    // prepare all subtitle images arrays
    @StringRes
    private static final int[] PAGE_IMAGE = new int[]{R.drawable.intro_a1, R.drawable.intro_a2, R.drawable.intro_a3};
